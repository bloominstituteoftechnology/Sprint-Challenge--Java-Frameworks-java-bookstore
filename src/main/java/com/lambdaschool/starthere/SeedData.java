...
import com.lambdaschool.starthere.models.UserRole;
...
public class SeedData implements CommandLineRunner
{
    ...
    public void run(String[] args) throws Exception
    {
        ...
        admins.add(new UserRole(new User(), r3));
        ...
        datas.add(new UserRole(new User(), r3));
        datas.add(new UserRole(new User(), r2));
